...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _handleRegister() async {
    ...
    if (success && mounted) {
      ...
      // En vez de ir al Dashboard, simplemente cerramos la pantalla de registro
      // para que el usuario vuelva a ver la pantalla de Inicio de Sesión.
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView( // Agregado para que no tire error de pantalla chica con el teclado
